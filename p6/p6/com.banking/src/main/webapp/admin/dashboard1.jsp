...
<body>
    ...
    <div>
        ...
        <a href="${pageContext.request.contextPath}/admin/register-customer.jsp">Register New Customer</a>
        <a href="${pageContext.request.contextPath}/admin/dashboard.jsp">Customer Details</a>
        <a href="${pageContext.request.contextPath}/admin/login.jsp">Logout</a>
    </div>
